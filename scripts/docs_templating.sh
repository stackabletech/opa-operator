...
chmod +x "docs/modules/opa-operator/examples/getting_started/getting_started.sh" \
  || chmod +x "docs/modules/opa-operator/examples/getting_started/code/getting_started.sh" \
  || true
