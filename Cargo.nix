  ...
  internal = rec {
    ...
    crates = {
      ...
      "libgssapi 0.8.1" = rec {
        ...
        version = "0.8.1";
        edition = "2018";
        sha256 = "0mgxi2mk360zqd3mp036967qfmar1b66pgq2gmd56b0gqb3bczxv";
        authors = [
          "Eric Stokes <letaris@gmail.com>"
        ];
        dependencies = [
      ...
      "libgssapi-sys" = rec {
        ...
        edition = "2018";
        links = "gssapi_krb5";
        sha256 = "0mb1qwxci0cgkis8f7a1ff4q2qhipyi8728xqaif26gaq3i9dymh";
      ...
      "ordered-float 4.5.0" = rec {
        crateName = "ordered-float";
        version = "4.5.0";
        edition = "2021";
        sha256 = "0ppqpjrri5r5vdz06na24d00cjaz67ambd1hcq13iy8vf3wy2pn6";
        libName = "ordered_float";
        authors = [
          "Jonathan Reem <jonathan.reem@gmail.com>"
          "Matt Brubeck <mbrubeck@limpet.net>"
      ...
      "raw-cpuid" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "1c77cmsn7rj6knwwrg2y9nl46wss5p9jq3wzxvr1a5k6bhql1chs";
        libName = "raw_cpuid";
        authors = [
      ...
      "thiserror 2.0.6" = rec {
        ...
        dependencies = [
          {
            name = "thiserror-impl";
            packageId = "thiserror-impl 2.0.6";
          }
        ];
        features = {
          "default" = [ "std" ];
      ...
      "thiserror-impl 2.0.6" = rec {
        crateName = "thiserror-impl";
        version = "2.0.6";
        edition = "2021";
        sha256 = "04k3dz901mymm06j3x6f65hpbsqlk6g51fmiky9g2kqgnk550myn";
        procMacro = true;
        libName = "thiserror_impl";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
      ...
      "tower" = rec {
        ...
        resolvedDefaultFeatures = [ "__common" "buffer" "filter" "futures-core" "futures-util" "log" "make" "pin-project-lite" "sync_wrapper" "tokio" "tokio-util" "tracing" "util" ];
      };
      "tower-http" = rec {
