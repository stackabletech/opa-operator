...
rec {
  ...
  workspaceMembers = {
    ...
    "stackable-opa-resource-info-fetcher" = rec {
      packageId = "stackable-opa-resource-info-fetcher";
      build = internal.buildRustCrateWithFeatures {
        packageId = "stackable-opa-resource-info-fetcher";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cross-krb5" = rec {
        ...
        version = "0.4.2";
        edition = "2021";
        sha256 = "122ifxl0yak526h4j6jj5sh5pk0v0chl8hqxn4bcjkg675qxykcx";
        libName = "cross_krb5";
        authors = [
      ...
      "info-fetcher-commons" = rec {
        crateName = "info-fetcher-commons";
        version = "0.0.0-dev";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./rust/info-fetcher-commons; };
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "reqwest";
            usesDefaultFeatures = false;
            features = [ "json" "form" "query" "native-tls" "charset" "http2" "system-proxy" ];
          }
          {
      ...
      "jsonpath-rust" = rec {
        ...
        version = "1.0.6";
        edition = "2021";
        sha256 = "0h2dw4gkwy8h9m5lvxg84wbi6zvr9349cd8ip9cgxpkl6mif1nx2";
      ...
      "kube" = rec {
        ...
        version = "4.2.0";
        edition = "2024";
        sha256 = "065z77zh7gbigcbv7mxk7firdf1w6278lal1jjqsnrh073hpz390";
        authors = [
      ...
      "kube-client" = rec {
        ...
        version = "4.2.0";
        edition = "2024";
        sha256 = "1lqny49zldysk1qr6pp2ifsp2ifqa5wcwplbj73wb9rk62kl1s9i";
        libName = "kube_client";
        authors = [
          "clux <sszynrae@gmail.com>"
          "Natalie Klestrup Röijezon <nat@nullable.se>"
      ...
      "kube-core" = rec {
        ...
        version = "4.2.0";
        edition = "2024";
        sha256 = "1d7f2acgydnica3gsva5my87kw8cbfyvbq1f6ln4dwwc24y3blm9";
        libName = "kube_core";
        authors = [
          "clux <sszynrae@gmail.com>"
          "Natalie Klestrup Röijezon <nat@nullable.se>"
      ...
      "kube-derive" = rec {
        ...
        version = "4.2.0";
        edition = "2024";
        sha256 = "1h597lx7xd6x65ili9ccm8lmqdq3dg3384iwcf8vz0zsw4ciq54j";
        procMacro = true;
        libName = "kube_derive";
        authors = [
          "clux <sszynrae@gmail.com>"
      ...
      "kube-runtime" = rec {
        ...
        version = "4.2.0";
        edition = "2024";
        sha256 = "1isw7mh35jmfwi3kx9ibpcgw77lyv9h3ji2ajdgabgn7f7pn9c1y";
      ...
      "lber" = rec {
        ...
        version = "0.5.1";
        edition = "2024";
        sha256 = "198956hgqyf3lbbcvcmqm51mlcv6jyashac3926zxndz4jb5bkyb";
        authors = [
      ...
      "ldap3" = rec {
        ...
        version = "0.12.1";
        edition = "2024";
        sha256 = "00vmbhgdiscfv1ah757fk9m053im02gzyf1s3rqf9dygwzsqkzh1";
        authors = [
          "Ivan Nejgebauer <inejge@gmail.com>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "cross-krb5" "default" "gssapi" "sync" "tls" "tls-native" ];
      };
      "libc" = rec {
        crateName = "libc";
        version = "0.2.189";
      ...
      "libgssapi-sys" = rec {
        ...
        edition = "2018";
        links = "gssapi_krb5";
        sha256 = "05yfb53ldidll20d3yw8jvdx6rl97ya4nrcbczzkdkgaax2sq0si";
      ...
      "moka" = rec {
        ...
        resolvedDefaultFeatures = [ "future" ];
      };
      "native-tls" = rec {
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__native-tls" "__native-tls-alpn" "__tls" "blocking" "charset" "form" "http2" "json" "native-tls" "query" "system-proxy" ];
      };
      "rfc6979" = rec {
        crateName = "rfc6979";
        version = "0.4.0";
      ...
      "snafu 0.9.2" = rec {
        ...
        version = "0.9.2";
        edition = "2018";
        sha256 = "1dx44pj4nid04lv64rjbhwihz3bd4arqg637df97pfwa0c2bcp74";
        authors = [
          "Jake Goulding <jake.goulding@gmail.com>"
        ];
        dependencies = [
      ...
      "snafu-derive 0.9.2" = rec {
        crateName = "snafu-derive";
        version = "0.9.2";
        edition = "2018";
        sha256 = "0whyc1bp26laq8sczsfkr13cq6kccrnij0rvbv7xgw08000mjzr8";
        procMacro = true;
        libName = "snafu_derive";
        authors = [
          "Jake Goulding <jake.goulding@gmail.com>"
      ...
      "stackable-opa-resource-info-fetcher" = rec {
        crateName = "stackable-opa-resource-info-fetcher";
        version = "0.0.0-dev";
        edition = "2024";
        crateBin = [
          {
            name = "stackable-opa-resource-info-fetcher";
            path = "src/main.rs";
            requiredFeatures = [ ];
          }
        ];
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./rust/resource-info-fetcher; };
        authors = [
          "Stackable GmbH <info@stackable.tech>"
        ];
        dependencies = [
      ...
      "tokio-util" = rec {
        ...
        resolvedDefaultFeatures = [ "codec" "default" "io" "libc" "slab" "time" ];
      };
      "tonic" = rec {
        crateName = "tonic";
        version = "0.14.6";
