  ...
  internal = rec {
    ...
    crates = {
      ...
      "dyn-clone" = rec {
        ...
        version = "1.0.18";
        edition = "2018";
        sha256 = "0dag651ph5q0mcax74y4m1k9hyl737q1v03isck3mzxsfd7g9vpy";
        libName = "dyn_clone";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "libgssapi 0.8.2" = rec {
        ...
        version = "0.8.2";
        edition = "2018";
        sha256 = "082aqg7id6h057iyl0wphsy401kgw4hf8ba4kp5dskrxddm5ydh3";
        authors = [
          "Eric Stokes <letaris@gmail.com>"
        ];
        dependencies = [
      ...
      "moka" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "loom";
            packageId = "loom";
            target = { target, features }: (target."moka_loom" or false);
          }
          {
            name = "parking_lot";
            packageId = "parking_lot";
