    ...
    crates = {
      ...
      "k8s-version" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "57d8d1270016fdbe159fdf39b60cd02b465935af";
          sha256 = "1gnp9j4wqfbyycds640xcf31qdafp7fy1gy81iw78wrqx49p3fhf";
        };
        libName = "k8s_version";
        authors = [
      ...
      "libgit2-sys" = rec {
        ...
        edition = "2021";
        links = "git2";
        sha256 = "1dqmkgxgxb937kkcsf05r93a9li385b92wfgxwi1p1z16mpzc9lv";
        libName = "libgit2_sys";
        libPath = "lib.rs";
        authors = [
          "Josh Triplett <josh@joshtriplett.org>"
