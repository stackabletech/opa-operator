  ...
  internal = rec {
    ...
    crates = {
      ...
      "hyper-util" = rec {
        ...
        resolvedDefaultFeatures = [ "client" "client-legacy" "default" "http1" "http2" "server" "service" "tokio" "tracing" ];
      };
      "iana-time-zone" = rec {
      ...
      "libgssapi 0.8.3" = rec {
        ...
        version = "0.8.3";
        edition = "2018";
        sha256 = "0iimzk0sir18csgan3n3rk7iqk0wdcgk1najxlz7zsgj2ggnirmr";
        authors = [
          "Eric Stokes <letaris@gmail.com>"
        ];
        dependencies = [
