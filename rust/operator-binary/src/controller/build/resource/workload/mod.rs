...
use crate::{
    controller::{
        ...
        build::{self, resource::workload::user_info_fetcher::add_user_info_fetcher_sidecar},
    },
...
/// the workload object of their choice; see [`daemonset::build_server_rolegroup_daemonset`].
