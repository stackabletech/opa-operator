...
The resources it reconciles, and the configuration they accept, are described in the [documentation](https://docs.stackable.tech/home/stable/opa/).Each CRD is also browsable on the [Stackable Hub](https://hub.stackable.tech/components/opa), with its schema and the API versions served per SDP release.
## Links
