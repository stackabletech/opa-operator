...
docker:
	docker build --force-rm -t "docker.stackable.tech/stackable/opa-operator:${VERSION}" -t "docker.stackable.tech/stackable/opa-operator:latest" -f docker/Dockerfile .
