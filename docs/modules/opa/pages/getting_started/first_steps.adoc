...
After you went through the xref:getting_started/installation.adoc[], on this page you will deploy an OPA, deploy your first rule and query it from the command line.
