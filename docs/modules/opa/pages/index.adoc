...
:crd: {crd-docs}/opa.stackable.tech/opacluster/v1alpha1/
...
The xref:getting_started/index.adoc[Getting started guide] will guide you through the installation of the operator and setting up OPA.
...
* The {crd}[OpaCluster {external-link-icon}^] CRD documentation
