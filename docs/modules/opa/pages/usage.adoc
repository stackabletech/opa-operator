...
The Stackable operator for OPA only supports automatic log configuration due to the lack of customization for the OPA logging. There can be no other `loggers` than the `ROOT` logger.
